		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Busca Imagens",
									"targetURL": "#Leandroimagesearch-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Leandroimagesearch-display": {
								"semanticObject": "Leandroimagesearch",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Leandro.imagesearch",
									"url": sap.ui.require.toUrl("Leandro/imagesearch")
								}
							}
						}
					}
